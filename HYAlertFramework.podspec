#
# Be sure to run `pod lib lint HYAlertFramework.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/oceanfive/HYAlertFramework.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'HYAlertFramework/Classes/**/*'
